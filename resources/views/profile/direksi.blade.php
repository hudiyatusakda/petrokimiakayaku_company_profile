        ...
        <div class="container">
            ...
            <div class="row align-items-center commissioner-item" data-aos="fade-up">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="profile-img-wrapper">
                        <img src="assets/img/muammar-maarif.jpg" alt="Foto Komisaris Utama">
                    </div>
                </div>

                <div class="col-lg-6">
                    <div class="profile-content">
                        <h2>Muammar Ma`arif</h2>
            ...
            <div class="row align-items-center commissioner-item" data-aos="fade-up">
                ...
                <div class="col-lg-6 order-2 order-lg-1">
                    <div class="profile-content text-lg-end text-center"> <h2>Iqbal Wahyudi</h2>
                ...
                <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
                    <div class="profile-img-wrapper">
                        <img src="assets/img/iqbal-wahyudi.jpg" alt="Foto Direksi">
                    </div>
                </div>
