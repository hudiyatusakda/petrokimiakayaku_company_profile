            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="video-desc-box" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p>{!! $video->description ? nl2br(e($video->description)) : 'Tidak ada deskripsi' !!}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="playlist-container">
                        @forelse($video_lainnya as $v)
                        <a href="{{ route('video.detail', $v->slug) }}" class="video-ghost-item" data-aos="fade-left">
                        ...
                        @empty
                        <div class="alert alert-light">Tidak ada video lain.</div>
                        @endforelse
                    </div>
                </div>
            </div>
